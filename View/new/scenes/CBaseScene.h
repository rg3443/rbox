...
public:
    ...
    //void SetDialogBlock(SDialogBlock val, int id) { dialogBlockList[id] = val; }
    ...
    //void AddDialogBlock(SDialogBlock val) { dialogBlockList.push_back(val); }
...
protected:
    ...
    //kuda yego suvat'? eto dynamic shiet|kto znaet kakie CPerson(ili SPawn?) budut na CLocation//vector<SDialogBlock> dialogBlockList;
};

...
#include "../../pcgGlobal.h"
//#include "../../../3dparty/Economic/economy_ph.h"
#include "../../../3dparty/Economic/products/CBaseProduct.h"
//using namespace Economy;

const int AMMOUNT_EVENTS_PER_TURN = 3;
const int CLAN_AMMOUNT = 3;
const int PERSON_AMMOUNT = 25000;
const int LOCATION_SIZE = 100;
const int CHUNK_AMMOUNT = 10;
...
struct SProperty {
	...
	//new new new//
	bool dealing;
	vector<Economy::CBaseProduct*> productList;
	vector<Economy::CBaseProduct*> productionList;
	vector<Economy::CBaseProduct*> consumptionList;
	SProperty() {}
